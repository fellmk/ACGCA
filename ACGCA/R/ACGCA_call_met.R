...
# NOTE: I modified sparms and gparms they were sparms2 and gparms2 I think this
# was done due to the oritional attempts I made to run many sets of parameters
# at the same time.
ACGCArun <- function(sparms, gparms, r0=0.05){
  #t<- numeric(0)	
