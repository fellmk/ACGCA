...
#plot(x= 1:1600/16, y=acgcaout$growth_clr[1:1600], xlab="years", ylab="labile carbon in leaves and fine roots (g gluc)", type="l")
#plot(x= 1:1600/16, y=acgcaout$growth_cs[1:1600], xlab="years", ylab="labile carbon in sapwood (g gluc)", type="l")
...
Fell, M, Ogle, K. 2018. Refinement of a theoretical trait space for North American trees via environmental filtering. Ecological Monographs 88:372-384
