...
For a full description of the model see (Ogle and Pacala 2009). The model has also been used in several other studies (Fell et al. 2018 and Gemoets et al 2013).
...
library(knitr)
library(kableExtra)
knitr::kable(data.frame(parameter.names=parms, parameter.values=acru), caption = "Acer rubrum parameters", align=c("l", "r"), "html") %>%
