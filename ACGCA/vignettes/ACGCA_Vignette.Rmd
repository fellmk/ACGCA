...
acgcaout <- ACGCA::runacgca(sparms = acru, r0 = 0.0054, parmax = 2060, years = 50, steps = 16, gapvars=gapvariables, gapsim=TRUE, fulloutput = TRUE)

# make a plot of the radius over time and the growth state over time.
par(mar=c(4,4,1,1))
plot(x= 1:801/16, y=acgcaout$r, xlab="years", ylab="radius (m)", type="l")
plot(x= 1:800/16, y=acgcaout$growth_st[1:800], xlab="years", ylab="growth state", type="l")
plot(x= 1:800/16, y=acgcaout$growth_clr[1:800], xlab="years", ylab="labile carbon in leaves and fine roots (g gluc)", type="l")
plot(x= 1:800/16, y=acgcaout$growth_cs[1:800], xlab="years", ylab="labile carbon in sapwood (g gluc)", type="l")
```
